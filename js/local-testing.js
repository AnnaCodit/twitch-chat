...
document.addEventListener('keydown', (e) => {
    if (e.code === 'Space') {
        ...
        const sampleTexts = [
            ...
            `Ого, какой крутой оверлей! Очень длинное сообщение для проверки того, как TypeIt переносит строки при печатании текста и как блок растет по высоте. ${hackEmote} ${hackEmote} ${hackEmote}`,
